...
##### - Used command: `rm -rf lab7` to delete past directory of it, then I copied and pasted the forked repo with these key presses : `<Command-C>` --> `git@github.com:dreyes32/lab7.git` then `git clone` + `<Command-V><enter>` , Therefore the command would look like `git clone git@github.com:dreyes32/lab7.git`
